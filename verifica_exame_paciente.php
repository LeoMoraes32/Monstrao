        ...
        <div class="container-fluid" style="border:green; border-radius:0; background-color:green">
            ...
            <div
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li role="presentation"><a style="color:white; font-weight: bold;" href="verifica_consulta_paciente.php">Verificar Consulta</a></li>
                    <li class="active" role="presentation" ><a  style="color:black; font-weight: bold;" href="verifica_exame_paciente.php">Verficar Exame</a></li>
        ...
        <div class="col-md-8 col-md-offset-2">
            <form method="post" class="form-horizontal custom-form">
                ...
                <div class="form-group">
                    ...
                    <input class="btn btn-default submit-button" style="background-color:green;"type="submit" name="verifica" value="verifica"/></form>
                </div>
