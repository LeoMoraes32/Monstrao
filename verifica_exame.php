        ...
        <div class="container-fluid" style="border:green; border-radius:0; background-color:green">
            ...
            <div
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active" role="presentation"><a style="color:black; font-weight:bold;" href="verifica_exame.php">Verficar Exame</a></li>
    ...
    <div class="row register-form">
        <div class="col-md-8 col-md-offset-2">
            <form method="post" action="" class="form-horizontal custom-form">
                ...
                <?php
                if ($error) {
                    echo "<p class='erro'> Nenhum paciente com o CPF inserido encontrado </p>" ; 
                }
                if ($achou) {
