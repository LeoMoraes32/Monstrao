        ...
        <div class="container-fluid" style="border:green; border-radius:0; background-color:green">
            ...
            <div
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="active" role="presentation"><a style="color:black; font-weight:bold;" href="#">Adicionar Exame</a></li>
    ...
    <div class="row register-form">
        <div class="col-md-8 col-md-offset-2">
            <form method="post" action="" class="form-horizontal custom-form">
                ...
                <input class="btn btn-default submit-button" style="background-color:green;" type="submit" value="cadastrar" name="cadastrar"/>
                <?php
                if ($error) {
